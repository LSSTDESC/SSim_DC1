...
objects can be seen. This bias is smaller than 15 mas and it will not affect the results of the two point clustering studies that
were the main focus of this simulations. \textcolor{red}{Check origin of these biases: Some pepole suggest proper motion: Why then
...
For the internal checks we select different overlapping visits and estimate the astrometric residuals between them.
